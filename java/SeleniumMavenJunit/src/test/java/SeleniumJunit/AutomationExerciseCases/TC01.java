...
public class TC01 {
    ...
    public void radioButtonTest() throws InterruptedException {
        ...
        //18. Verify that 'ACCOUNT DELETED!' is visible and click 'Continue' butt
        ...
        //6. Enter name and email address
        driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("barisecanatses");
        driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("caneatses@gmail.com");
        //7. Click 'Signup' button
        ...
        sifreGirin.sendKeys("123456" + Keys.ENTER);
        Thread.sleep(3000);
